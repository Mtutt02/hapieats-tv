...
export default async function TVPage() {
  try {
    ...
    const stations = (stationRows ?? []) as {
      id: string; slug: string; name: string
      icon: string | null; description: string | null; theme: string | null
    }[]
    const videos = (videoRows ?? []) as {
      title: string; mux_playback_id: string | null
      duration: number | null; station_id: string | null
    }[]
